export const metadata = {
  title: 'Privacy Policy | CreditRich',
  description: 'Privacy Policy for CreditRich - How we collect, use, and protect your data.',
}
      ...
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="mb-12 border-b border-border/40 pb-8">
          ...
          <p className="text-muted-foreground/80 mt-4 text-base leading-relaxed max-w-3xl">
            CreditRich is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your information when you use our credit card optimization platform.
          </p>
        </div>
        ...
        <article className="prose prose-invert prose-cyan max-w-none">
          <h2>Introduction</h2>
          <p>
            This Privacy Policy describes how CreditRich ("we," "our," or "us") handles your personal information when you use our website and services. We prioritize transparency and security in all data practices.
          </p>
          ...
          <ul>
            <li>Authentication credentials are managed by Clerk, not stored by CreditRich</li>
            <li>Payment card details are processed by Stripe, not stored by CreditRich</li>
            <li>Bank login credentials are handled by Plaid, never accessible to CreditRich</li>
          </ul>
          ...
          <div className="space-y-6 not-prose">
            <div className="border border-border/40 rounded-lg p-5 bg-card/30">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Handles user authentication and account management. Your login credentials and email are processed by Clerk's secure infrastructure. CreditRich does not store passwords or authentication tokens.
              </p>
            </div>
            ...
            <div className="border border-border/40 rounded-lg p-5 bg-card/30">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Processes all Premium subscription payments. Your payment card details are handled exclusively by Stripe's PCI-compliant systems. CreditRich never stores complete credit card information.
              </p>
            </div>
            ...
            <div className="border border-border/40 rounded-lg p-5 bg-card/30">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                Premium users may optionally connect bank accounts to enable automatic spend tracking. Plaid securely accesses your transaction data. CreditRich receives only aggregated transaction information necessary for spend categorization.
              </p>
              <p className="text-sm text-muted-foreground/80">
                Important: Your bank login credentials are handled exclusively by Plaid and are never accessible to CreditRich. You can revoke bank access at any time.
              </p>
            </div>
            ...
            <div className="border border-border/40 rounded-lg p-5 bg-card/30">
              <h3 className="text-lg font-semibold mb-2 text-foreground">Google Gemini — AI Content Generation</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Used exclusively to generate comparison verdicts for card-vs-card comparison pages. Card specifications and bonus details are sent to Google's Gemini API for content generation. This AI service is not used for recommendation calculations.
              </p>
            </div>
          </div>
          ...
          <p>
            CreditRich participates in affiliate marketing programs with credit card issuers. When you apply for a card through our affiliate links, we may earn a commission from the issuer at no cost to you.
          </p>
          ...
          <p className="text-sm text-muted-foreground/80 mt-4">
            To exercise these rights, contact us at <a href="mailto:privacy@CreditRich.com" className="text-cyan-400 hover:text-cyan-300">privacy@CreditRich.com</a>. We will respond within 30 days.
          </p>
          ...
          <p>
            CreditRich is not intended for individuals under 18. We do not knowingly collect information from children. If you believe a child has provided us with personal information, please contact us immediately.
          </p>
          ...
          <ul>
            <li>Email: <a href="mailto:privacy@CreditRich.com" className="text-cyan-400 hover:text-cyan-300">privacy@CreditRich.com</a></li>
          </ul>

          <div className="mt-12 pt-8 border-t border-border/40">
            <p className="text-sm text-muted-foreground/70">
              This Privacy Policy was last updated on March 13, 2026. By using CreditRich, you acknowledge that you have read and understood this policy.
            </p>
          </div>
        </article>
      </div>
