    ...
    <div className="min-h-screen pb-12 relative bg-[#0A0B0F]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-10">
          <div className="text-center mb-8">
            ...
            <p className="text-lg sm:text-xl text-gray-400 font-light leading-relaxed max-w-2xl mx-auto">
              Most tools tell you which card is "best." CreditRich goes further — it analyzes your real spending and builds a personalized strategy, so every purchase earns maximum rewards.
            </p>
          </div>
      ...
      <div id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/5">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-gray-400 max-w-2xl mx-auto">
            Most platforms compare credit cards. CreditRich goes further.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/[0.02] backdrop-blur-sm border border-white/[0.05] rounded-xl p-6 hover:border-cyan-500/30 transition-all h-full">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Choosing the "best" card isn't enough. What matters is using the right card for each purchase — and that's exactly what CreditRich does.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="text-center mb-6 space-y-2">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  CreditRich tells you exactly which card to use for every purchase — so you never miss out on rewards.
                </p>
              </div>
