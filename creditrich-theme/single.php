...
<nav class="breadcrumb" aria-label="Breadcrumb">
    <a href="<?php echo esc_url(get_bloginfo('url')); ?>"><?php _e('Blog', 'GoRewards'); ?></a>
    ...
    <div class="post-hero-grid">
        <div class="post-hero-left">
            ...
            <div class="post-meta-row">
                ...
                <div class="read-time-pill">
                    ...
                    <?php echo GoRewards_reading_time(); ?>
                </div>
        ...
        <?php if (has_post_thumbnail()) : ?>
            <div class="hero-image-wrap">
                <?php the_post_thumbnail('GoRewards-hero', ['alt' => get_the_title()]); ?>
            </div>
        <?php endif; ?>
    </div>
</header>
...
<div class="post-layout">
    ...
    <article class="article-body">
        ...
        <div class="author-bio">
            ...
            <div class="author-bio-content">
                ...
                <div class="author-bio-role"><?php echo get_the_author_meta('user_title', $author_id) ?: __('Author', 'GoRewards'); ?></div>
    ...
    <aside class="sidebar" aria-label="Article sidebar">
        ...
        <div class="cta-widget">
            ...
            <h4><?php _e('Find Your Perfect Card', 'GoRewards'); ?></h4>
            <p><?php _e('Answer 3 quick questions and GoRewards will match you to the highest-value card for your spending.', 'GoRewards'); ?></p>
            <a href="https://GoRewards.net" class="cta-widget-btn" target="_blank" rel="noopener">Try GoRewards Free →</a>
